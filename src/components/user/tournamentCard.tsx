...
//   return (
//     <div className="w-[377px] rounded-xl overflow-hidden shadow-md border border-gray-200 bg-white">
//        {/* <Image
//     src={data.image}
//     alt="Stadium"
//     fill
...
// }\
return (
  <div className="w-[340px] h-[450px] rounded-2xl shadow-md border border-gray-100 overflow-hidden transition hover:shadow-lg">
    ...
    <div className="relative h-40 w-full">
      ...
      {/* Status Badge */}
      <span className="absolute top-3 left-3 text-xs bg-green-500 text-white px-3 py-1 rounded-full font-medium">
        {data.status}
      </span>
    </div>
    ...
    <div className="p-4 space-y-2">
      ...
      {/* Location */}
      <div className="flex items-center justify-center text-xs text-gray-600 gap-1">
        <FaMapMarkerAlt />
      ...
      <div className="flex justify-between text-xs text-gray-600">
        ...
        <div className="flex items-center gap-1">
          ...
          <span>
            ...
            {moment(data.dateTo).format("MMM D")}
          </span>
        </div>
      </div>
